...
public class JwtUtil {
    ...
    public final String USER_LoginID = "userLoginId";
    ...
    public String getUserLoginId(String token) {
        ...
        return getValue(token, USER_LoginID);
    }
    ...
    public String getUserLoginId(HttpServletRequest request) {
        ...
        return getValue(getAuthToken(request), USER_LoginID);
    }
    ...
    public Boolean validateToken(String token, PrincipalDetails principalDetails) {
        ...
        final String userEmail = getValue(token, USER_LoginID);
    ...
    public String createAccessToken(UserEntity user) {
        ...
        payload.put(USER_LoginID, user.getLoginId());
        payload.put(USER_PERMISSION, "USER");
